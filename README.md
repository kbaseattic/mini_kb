...
1. The mini-kb front proxy is now listening on port 80. KBase services can be found under http://localhost/services/{servicename}
...
120:mini_kb sychan$ curl http://localhost/kbase-ui/build-info.js
<html>
